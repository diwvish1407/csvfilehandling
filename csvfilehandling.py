...
if __name__ == '__main__':
    ...
    while(condition):
        student_info = input(
            "Enter students information for student {} in the following format (name age contact_no email_id): ".format(student_num))
        ...
        if choice_check == "yes":
            ...
            condition_check = input(
                "Enter (yes / no) if you want to enter the information for other students.")
